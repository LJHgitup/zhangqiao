...
function selectReferDocPop(){
 ...
 // 展开摘要
    ...
    this.searchReferDocList=function(searchparam){
        ...
        $(".literatureList").html("");
        if (!$(".literatureList").is(":visible")) {
            $(".noliteratureListStatus").remove();
            $('#selectDocPop').next().after(`<div class="noliteratureListStatus"></div>`);
            this.loadingHtml(".noliteratureListStatus");
        } else {
